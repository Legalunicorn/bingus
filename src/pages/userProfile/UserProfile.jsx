...
const UserProfile = () => {
    ...
    if (user && user.profile?.website){
        user.profile.website = user.profile.website.startsWith("http")? user.profile.website: `https://${user.profile.website}`
    }
    if (user && user.profile?.github){
        user.profile.github = user.profile.github.startsWith("http")? user.profile.github: `https://${user.profile.github}`
    }
                    ...
                    <>
                        ...
                        <div className="profile-details">
                            ...
                            {user?.profile?.website &&
                                <div>
                                    <IconWorld />
                                    <a href={`${user.profile.website.trim()}`} target="_blank">{user.profile.website}</a>
                                </div>
                            }
                            {
                                user?.profile?.github &&
